  ...
  const CashoutBothDetails& cb) const
{
      ...
      Holding::TopsOverRank(QT_ACE, cb.minPard) < cb.lenShort)
  {
    ...
    if (cb.lenShort == 2 &&
        completeList[cb.pLong][1] > completeList[cb.pShort][0])
    {
      unsigned ra4 = HR(QT_ACE, t1-s);
      trick[3].Set(QT_BOTH, QT_ACE, ra4, 2);
      return def.Set31(trick);
    }
    else if (cb.lenShort == 3 &&
        completeList[cb.pLong][2] > completeList[cb.pShort][0])
    {
      unsigned ra4 = HR(QT_ACE, t1-s);
      trick[3].Set(QT_BOTH, QT_ACE, ra4, 3);
      return def.Set31(trick);
    }
    else if (cb.lenShort == 3 && 
        cb.lenOppHighest == 1 && cb.lenOppLowest >= 3 &&
        cb.numTopsLongLow == 2 &&
        SDS_QUEEN - cb.lenOppHighest > ra2)
    {
      unsigned ra4 = SDS_QUEEN - cb.lenOppHighest;
      trick[3].Set(QT_PARD, QT_BOTH, ra4, 3);
      return def.Set31(trick);
    }
    else
      return def.Set3(trick[0], trick[1], trick[2]);
  ...
  const CashoutBothDetails& cb) const
{
    ...
    cb.numTopsLow == Min(cb.lenLong, cb.lenOppLowest))
  {
    ...
    unsigned re = (cb.lenOppLowest > cb.lenShort && r1 < lowestRank ?
      r1 : SDS_VOID);
    ...
    cb.lenOppHighest == 2 && cb.lenOppLowest == 4)
  {
    ...
    r0 = HR(cb.pLong, 0);
    // t0 = 1;
    // t0 = (cb.pLong == QT_PARD && htop.T == QT_ACE ? 2 : 1);
    if (cb.pLong == QT_PARD && 
        completeList[QT_ACE][1] > completeList[QT_PARD][1] &&
        completeList[QT_ACE][1] > completeList[cb.pOppLowest][0])
      t0 = 2;
    else
      t0 = 1;
    r1 = HR(cb.pShort, 1);
  ...
  unsigned r3 = Max(HR(cb.pLong, 1), HR(cb.pShort, 1));

  if (cb.numTopsLongHigh == 2 && cb.numTopsShortHigh == 1)
  {
    trick[3].Set(QT_PARD, QT_BOTH, SDS_QUEEN, 3);
    return def.Set31(trick);
  }
  /*
      ...
      cb.lenOppHighest <= 2)
  {
    trick[3].Set(QT_PARD, QT_BOTH, r3, 3);
    return def.Set31(trick);
  }
  */
  else
        ...
        completeList[QT_ACE][3] > completeList[QT_RHO][1])
    {
          ...
          completeList[QT_PARD][0] > completeList[QT_RHO][0])
      {
        if (completeList[QT_ACE][3] < completeList[QT_RHO][0])
        {
          ...
          trick[3].Set(QT_BOTH, QT_ACE, r2, 3);
          return def.Set31(trick);
        }
  ...
  if (length[QT_PARD] == 2)
  {
    if (htop.T == QT_PARD)
    {
          ...
          completeList[QT_ACE][3] > completeList[QT_RHO][0])
      {
        ...
        trick[3].Set(QT_ACE, QT_ACE, rank, 3);
        return def.Set13(trick);
      }
      else
      {
        ...
        trick[0].Set(QT_BOTH, QT_ACE, r2, 3);
        trick[1].Set(QT_BOTH, QT_ACE, SDS_ACE, 1);
        trick[2].Set(QT_BOTH, QT_PARD, rank, 1);
        trick[3].Set(QT_ACE, QT_ACE, SDS_VOID, l-2);
        return def.Set13(trick);
      }
    }
  ...
  if (length[pp] == 2)
  {
    if (length[pl] >= 5)
    {
      ...
      else
      {
        ...
        rank = Max(r1, r2);
        trick[0].Set(QT_BOTH, QT_BOTH, SDS_JACK, 4);
        trick[1].Set(pa, pa, rank, 1);
        trick[2].Set(QT_BOTH, pp, SDS_VOID, 1);
        trick[3].Set(pa, pa, SDS_VOID, l-2);
        return def.Set13(trick);
      }
    }
    else // length[pr] >= 5
  ...
  else if (htop.N == pa || (htop.N == pp && htop.E == pa))
  {
    ...
    else
    {
      ...
      if (htop.J == QT_PARD)
      {
        trick[0].Set(pa, pa, rank, 5);
        trick[1].Set(pp, QT_BOTH, rank, 5);
        trick[2].Set(pa, pp, r1, 2);
        trick[3].Set(pa, pa, r2, 2);
        return def.Set112(trick);
      }
          ...
          completeList[QT_ACE][4] > completeList[QT_RHO][1])
      {
        // AKJ97 / - / Q8x / Txxxx.
        rank = HR(QT_ACE, 4);
        trick[0].Set(pa, pa, SDS_NINE, 5);
        trick[1].Set(pp, QT_BOTH, SDS_NINE, 5);
        trick[2].Set(pa, pp, rank, 3);
...
bool LoopHold::SolveComplex6(DefList& def, unsigned& rank) const
{
  ...
  else if (length[pp] >= 4 && length[pa] > length[pp] && length[pl] == 3)
  {
    if (htop.T == pa)
    {
      ...
      else
      {
        ...
        rank = HR(pp, 1);
        trick[0].Set(QT_BOTH, pa, SDS_TEN, 3);
    ...
    else if (htop.T == pr)
    {
          ...
          completeList[pp][3] > completeList[pa][3])
      {
        ...
        if (pickFlag) holdCtr[0x1463]++;
        rank = HR(pp, 1);
        trick[0].Set(QT_BOTH, pa, SDS_NINE, 3);
        trick[1].Set(QT_BOTH, pp, rank, 1);
        trick[2].Set(pa, pa, SDS_VOID, length[pa]-4);
        return def.Set3(trick[0], trick[1], trick[2]);
      }
  ...
  else if (length[pa] >= 4 && length[pp] > length[pa] && length[pl] == 3)
  {
    ...
    else if (htop.T == pp)
    {
      ...
      {
        // AT5432 / - / KJ76 / Q98.
        if (pickFlag) holdCtr[0x1462]++;
        rank = SDS_TEN;
        trick[0].Set(QT_BOTH, pp, rank, 3);
    ...
    if (length[pr] == 4)
    {
      if (htop.T == pp)
      {
            ...
            completeList[pa][2] > completeList[pp][2])
        {
          ...
          trick[1].Set(pa, QT_BOTH, SDS_VOID-5, length[pa]);
          trick[2].Set(pp, pp, SDS_VOID-5, length[pa]-1);
          trick[3].Set(pa, pa, SDS_VOID, 1);
          return def.Set112(trick);
        }
        else
        {
          ...
          trick[1].Set(pp, pa, HR(pa, 0), 1);
          trick[2].Set(QT_BOTH, pp, rank, 2);
          trick[3].Set(pa, pa, SDS_VOID, 1);
          return def.Set13(trick);
        }
      }
        ...
        if (htop.N == pp)
        {
              ...
              completeList[pa][2] > completeList[pr][1])
          {
            ...
            else
            {
              ...
              rank = HR(pa, 2);
              // The way it comes out.  Could also have 
              // pa-pp-HR(pa, 2)-3 + pa-pa-void-1.
              trick[0].Set(QT_BOTH, pa, rank, 4);
              trick[1].Set(pa, pp, SDS_JACK, 3);
              return def.Set11(trick[0], trick[1]);
            }
              ...
              completeList[pr][0] > completeList[pa][2])
          {
            ...
            else
            {
              ...
              unsigned r1 = HR(pa, 0);
              unsigned r2 = HR(pp, 0);
              // Works for A98 / 7432 / KJ65 / QT, 13/bb0695.
              trick[0].Set(QT_BOTH, pa, Min(r1, r2), 1);
              trick[1].Set(QT_BOTH, pp, rank, 2);
              // trick[0].Set(QT_BOTH, pa, Min(r1, r2), 2);
              // trick[1].Set(QT_BOTH, pp, rank, 1);
              trick[2].Set(pa, pa, SDS_VOID, 1);
              return def.Set3(trick[0], trick[1], trick[2]);
            }
      ...
      length[pl] == 3 && length[pr] == 2)
  {
    if (htop.T == pr && htop.N == pp && hopp.E)
    {
      ...
      if (pickFlag) holdCtr[0x106f]++;
      rank = HR(pp, 1);
      trick[0].Set(QT_BOTH, pa, SDS_KING, 2);
      trick[1].Set(QT_BOTH, pp, rank, 1);
  ...
  if (length[QT_ACE] >= 4 && length[QT_LHO] == 1 && length[QT_RHO] >= 4)
  {
    ...
    else if (length[QT_PARD] == 2)
    {
      if (htop.T == QT_RHO)
      {
        ...
        if (rc > r2)
        {
          trick[3].Set(QT_BOTH, QT_ACE, rc, 2);
          return def.Set31(trick);
        }
        else
          return def.Set3(trick[0], trick[1], trick[2]);
...
bool LoopHold::SolveComplex11(DefList& def, unsigned& rank) const
{
      ...
      length[QT_LHO] >= 4 && length[QT_RHO] == 1)
  {
    if (htop.T == QT_LHO && htop.N == QT_ACE)
    {
      ...
      else if (htop.J == QT_ACE)
      {
        // The way it comes out.
        if (pickFlag) holdCtr[0x111e]++;
        rank = SDS_EIGHT;
        unsigned l = (length[QT_LHO] > 4 ? 4 : length[QT_ACE]);
      ...
      length[QT_RHO] == 1)
  {
    if (htop.Q == QT_ACE)
    {
      ...
      {
        l = length[QT_PARD] - 2;
        rank = length[QT_LHO] <= 2 ? SDS_VOID : SDS_JACK;
      }
      ...
      trick[0].Set(QT_BOTH, QT_ACE, r1, 2);
      trick[1].Set(QT_PARD, QT_PARD, rank, l);
      return def.Set2(trick[0], trick[1]);
    }
  }
...
bool LoopHold::SolveComplex12(DefList& def, unsigned& rank) const
{
  ...
  if (distHex == 0x4432 && htop.T == QT_PARD && htop.N == QT_PARD)
  {
    ...
    else
    {
      ...
      trick[2].Set(QT_ACE, QT_ACE, SDS_KING, 2);
      trick[3].Set(QT_BOTH, QT_PARD, SDS_TEN, 1);
...
bool LoopHold::SolveComplex14(DefList& def, unsigned& rank) const
{
  ...
  else if (length[pa] >= 4 && length[pp] == 3 && length[pl] == 2)
  {
        ...
        completeList[pa][2] > completeList[pr][1])
    {
      ...
      trick[2].Set(pp, pp, SDS_VOID-4, 3);
        ...
        completeList[pa][1] > completeList[pp][2])
    {
      ...
      rank = HR(pa, 1);
      trick[0].Set(pa, QT_BOTH, rank, length[pa]);
      trick[1].Set(pp, QT_BOTH, SDS_VOID-4, length[pa]-1);
      return def.Set11(trick[0], trick[1]);
    }
    else if (completeList[pa][1] > completeList[pr][1] &&
        completeList[pa][1] > completeList[pp][2])
  ...
  else if (length[pa] > length[pp] && length[pp] >= 4 && length[pl] == 2)
  {
    if (completeList[pp][length[pp]-1] > completeList[pa][1])
    {
      ...
      trick[0].Set(pa, QT_BOTH, SDS_VOID-4, length[pa]);
      trick[1].Set(pp, pa, SDS_VOID-2, 2);
      trick[2].Set(QT_BOTH, pp, rank, length[pp]-2);
      ...
      length[pp] == 4 && length[pr] == 4)
  {
        ...
        completeList[pr][0] > completeList[pp][2])
    {
      ...
      {
        // AJxx / 7xxx / K98 / QT.
        if (pickFlag) holdCtr[0x138c]++;
        rank = HR(pa, 1);
        trick[0].Set(pa, QT_BOTH, SDS_JACK, 3);
        trick[1].Set(QT_BOTH, pp, SDS_ACE, 1);
        trick[2].Set(QT_BOTH, pa, rank, 2);
        trick[3].Set(pp, pp, SDS_VOID, 1);
        return def.Set13(trick);
      }
    }
  }
    ...
    else if (length[QT_PARD] == 3)
    {
      ...
      else if (completeList[QT_PARD][0] > completeList[QT_LHO][0])
      {
        ...
        else
        {
          ...
          {
            trick[2].Set(QT_BOTH, QT_PARD, r1, 1);
            trick[3].Set(QT_ACE, QT_ACE, r2, length[QT_ACE]-3);
            return def.Set13(trick);
          }
        }
...
return false;
            ...
            rank = HR(QT_PARD, 0);
            unsigned r = (completeList[QT_RHO][2] > 
              completeList[QT_PARD][1] ? SDS_TEN : SDS_QUEEN);
            trick[2].Set(QT_PARD, QT_ACE, SDS_QUEEN, 1);
            trick[3].Set(QT_PARD, QT_ACE, SDS_TEN, length[QT_ACE]-1);
            trick[4].Set(QT_PARD, QT_ACE, r, 1);
...
return false;
      ...
      {
        if (pickFlag) holdCtr[0x1239]++;
        unsigned r = HR(QT_ACE, 3);
        rank = HR(QT_PARD, 0);
        trick[2].Set(QT_PARD, QT_ACE, SDS_TEN, 1);
        trick[3].Set(QT_PARD, QT_ACE, r, length[QT_ACE]-1);
        trick[4].Set(QT_PARD, QT_ACE, SDS_TEN, 1);
        trick[5].Set(QT_PARD, QT_PARD, rank, length[QT_PARD]-1);
...
// return def.Set1(trick[0]);
    ...
    {
      // PROBLEM (not done yet).
      if (pickFlag) holdCtr[0x1220]++;
      return false;
    }
    else if (length[QT_ACE] > length[QT_PARD])
    {
      // PROBLEM (not done yet).
      if (pickFlag) holdCtr[0x1221]++;
      return false;
    }
    else if (completeList[QT_ACE][2] > completeList[QT_RHO][2] &&
...
bool LoopHold::SolveComplex18(DefList& def, unsigned& rank) const
{
  ...
  if (distHex == 0x4153)
  {
        ...
        completeList[QT_ACE][3] > completeList[QT_PARD][1])
    {
      ...
      rank = SDS_VOID - 6;
      trick[0].Set(QT_BOTH, QT_PARD, SDS_VOID-3, 3);
        ...
        length[pp] == 3)
    {
          ...
          completeList[pr][0] > completeList[pa][2])
      {
        ...
        else if (completeList[pp][2] < completeList[pa][2])
        {
          ...
          else if (length[QT_ACE] == 4)
          {
            ...
            else
            {
              ...
              unsigned r = HR(pa, 0);
              rank = HR(pp, 1);
              trick[0].Set(QT_PARD, QT_BOTH, SDS_QUEEN, 3);
              trick[1].Set(QT_BOTH, pa, r, 1);
              trick[2].Set(QT_BOTH, pp, rank, 2);
              trick[3].Set(pa, pa, SDS_VOID, 1);
              return def.Set13(trick);
            }
        ...
        else if (length[QT_ACE] == 4)
        {
          // The way it comes out.  Not necessarily right.
          // AQ54 / JT / K93 / 8762.
          if (pickFlag) holdCtr[0x1188]++;
          rank = HR(pp, 1);
          trick[0].Set(QT_PARD, QT_BOTH, SDS_QUEEN, 3);
          trick[1].Set(QT_BOTH, QT_ACE, SDS_ACE, 1);
          trick[2].Set(QT_BOTH, QT_PARD, rank, 2);
          trick[3].Set(QT_ACE, QT_ACE, SDS_VOID, 1);
          return def.Set13(trick);
        }
        else
        {
          ...
          rank = HR(pp, 1);
          trick[0].Set(QT_ACE, QT_PARD, SDS_QUEEN, 3);
        ...
        if (completeList[pr][0] < completeList[pp][2])
        {
              ...
              completeList[pr][0] > completeList[pa][2])
          {
            ...
            if (length[QT_ACE] == 4)
            {
              ...
              if (pickFlag) holdCtr[0x118c]++;
              rank = HR(pp, 1);
              trick[0].Set(pp, QT_BOTH, SDS_QUEEN, 3);
              trick[1].Set(QT_BOTH, pa, SDS_ACE, 1);
              trick[2].Set(QT_BOTH, pp, rank, 2);
              trick[3].Set(pa, pa, SDS_VOID, 1);
              return def.Set13(trick);
            }
      ...
      (htop.T == QT_ACE && htop.N == QT_PARD))
  {
        ...
        completeList[QT_ACE][2] > completeList[QT_RHO][1])
    {
      ...
      else
      {
        ...
        trick[0].Set(QT_BOTH, QT_ACE, rank, 4);
        trick[1].Set(QT_BOTH, QT_ACE, SDS_VOID-1, 1);
        trick[2].Set(QT_BOTH, QT_PARD, r1, 2);
...
bool LoopHold::SolveComplex26(DefList& def, unsigned& rank) const
{
  ...
  if (length[pa] >= 5 && length[pp] == 4 && length[pl] == 3)
  {
    if (htop.T == pp)
    {
      if (completeList[pp][3] > completeList[pa][1])
      {
        ...
        rank = HR(pp, 2);
        trick[0].Set(pa, QT_BOTH, rank, length[pa]);
        trick[1].Set(pp, pa, SDS_VOID-3, 3);
        trick[2].Set(QT_BOTH, pp, rank, 1);
  ...
  else if (length[pa] == 3 && length[pp] >= 4 && length[pl] >= 4)
  {
    ...
    {
      // AKTx / xx / Qxx / Jxxx.
      // PROBLEM:  Should be pp,2 > pa,1 ?
      if (pickFlag) holdCtr[0x1264]++;
      return false;

      if (completeList[pa][1] > completeList[pp][3] &&
          completeList[pa][2] < completeList[pp][3])
      {
        // PROBLEM
        return false;
        ...
        if (pickFlag) holdCtr[0x1264]++;
        rank = HR(pa, 2);
        trick[0].Set(pp, pp, SDS_TEN, 4);
        trick[1].Set(pa, QT_BOTH, SDS_TEN, 4);
        trick[2].Set(pp, pa, rank, 3);
        trick[3].Set(pp, pp, SDS_VOID, length[pp]-3);
        return def.Set112(trick);
      }
      else if (completeList[pp][2] > completeList[pa][1])
      {
        ...
        rank = HR(pp, 2);
        trick[0].Set(QT_ACE, QT_PARD, SDS_QUEEN, 3);
        trick[1].Set(QT_ACE, QT_ACE, rank, 4);
        trick[2].Set(QT_PARD, QT_BOTH, rank, 4);
        return def.Set111(trick);
      }
      else
      {
        ...
        if (pickFlag) holdCtr[0x1264]++;
        rank = HR(pp, 2);
        trick[0].Set(pp, pp, rank, 4);
        trick[1].Set(pa, QT_BOTH, rank, 4);
        trick[2].Set(pp, pp, SDS_ACE, 1);
        trick[3].Set(QT_BOTH, pa, rank, 2);
        trick[4].Set(pp, pp, SDS_VOID, 1);
        return def.Set113(trick);
      }
    }
  }
  else if (length[pa] == 3 && length[pp] >= 4 && length[pr] >= 4)
  {
        ...
        completeList[pr][0] > completeList[pp][2])
    {
      ...
      if (length[QT_ACE] == 4)
      {
        ...
        rank = HR(pa, 1);
        trick[0].Set(pa, QT_BOTH, SDS_QUEEN, 3);
        trick[1].Set(QT_BOTH, pp, SDS_ACE, 1);
        trick[2].Set(QT_BOTH, pa, rank, 2);
        trick[3].Set(pp, pp, SDS_VOID, 1);
        return def.Set13(trick);
...
bool LoopHold::SolveComplex27(DefList& def, unsigned& rank) const
{
  ...
  else if (distHex == 0x5341)
  {
    ...
    else
    {
      ...
      rank = HR(QT_PARD, 1);
      trick[0].Set(QT_BOTH, QT_ACE, SDS_NINE, 3);
      trick[1].Set(QT_BOTH, QT_PARD, rank, 1);
      trick[2].Set(QT_ACE, QT_ACE, SDS_VOID, 1);
      return def.Set3(trick[0], trick[1], trick[2]);
    }
  ...
  else if (distHex == 0x4351)
  {
    ...
    else if (htop.N == QT_PARD)
    {
      ...
      else if (completeList[QT_ACE][3] > completeList[QT_PARD][2])
      {
        ...
        if (pickFlag) holdCtr[0x127b]++;
        rank = SDS_NINE;
        trick[0].Set(QT_BOTH, QT_PARD, rank, 3);
...
bool LoopHold::SolveComplex36(DefList& def, unsigned& rank) const
{
  ...
  if (length[QT_PARD] == 2)
  {
    if (length[QT_ACE] >= 4 && length[QT_RHO] >= 3)
    {
      if (htop.T == QT_RHO || (htop.T == QT_PARD && htop.N == QT_RHO))
      {
        // AKxx / Q / Jx / Txx.
      ...
      else if (distHex == 0x5125 && htop.T == QT_ACE && htop.N == QT_RHO)
      {
        // AKTxx / Q / Jx / 9xxxx.
        ...
        trick[0].Set(QT_BOTH, QT_ACE, SDS_TEN, 3);
        trick[1].Set(QT_BOTH, QT_ACE, SDS_ACE, 1);
        trick[2].Set(QT_BOTH, QT_PARD, SDS_JACK, 1);
        trick[3].Set(QT_ACE, QT_ACE, SDS_TEN, 2);
        return def.Set13(trick);
      }
    }
  }
  ...
  else if (length[QT_ACE] == 3)
  {
    if (length[QT_PARD] >= 4 && length[QT_RHO] >= 4)
    {
            ...
            completeList[QT_PARD][2] > completeList[QT_RHO][1])))
      {
        // AKx / Q / J98xx / Txxx.
        // AK8 / Q / J97xx / Txxx.
        // Feels like the seven matters here, but it's probably just
        // the way it comes out.
        ...
        trick[0].Set(QT_BOTH, QT_BOTH, SDS_JACK, 3);
        trick[1].Set(QT_BOTH, QT_ACE, SDS_ACE, 1);
        trick[2].Set(QT_PARD, QT_PARD, rank, 1);
        trick[3].Set(QT_BOTH, QT_ACE, SDS_VOID, 1);
        trick[4].Set(QT_PARD, QT_PARD, SDS_VOID, l-3);
        return def.Set14(trick);
      }
      else if (htop.T == QT_RHO && 
          completeList[QT_ACE][2] > completeList[QT_RHO][1])
      {
...
bool LoopHold::SolveComplex41(DefList& def, unsigned& rank) const
{
      ...
      length[QT_RHO] >= 3)
  {
    if (htop.N == QT_RHO || length[QT_ACE] == 3 || length[QT_RHO] == 3)
    {
      ...
      rank = SDS_TEN;
      trick[0].Set(QT_BOTH, QT_ACE, SDS_ACE, 1);
      trick[1].Set(QT_BOTH, QT_PARD, SDS_QUEEN, 1);
      ...
      length[QT_RHO] == 2 && length[QT_LHO] >= 3)
  {
       ...
       (htop.T == QT_ACE && htop.N == QT_PARD))
    {
      if (completeList[QT_LHO][0] > completeList[QT_ACE][2])
      {
        ...
        trick[0].Set(QT_BOTH, QT_ACE, SDS_VOID-2, 2);
        trick[1].Set(QT_PARD, QT_PARD, rank, 2);
      ...
      length[QT_RHO] == 2)
  {
    if (length[QT_LHO] == 4)
    {
        ...
        completeList[QT_ACE][3] > completeList[QT_LHO][0])
      {
        ...
        trick[2].Set(QT_ACE, QT_ACE, SDS_KING, 2);
        trick[3].Set(QT_BOTH, QT_PARD, SDS_JACK, 1);
          ...
          completeList[QT_ACE][2] > completeList[QT_LHO][0])
      {
        ...
        rank = Min(r1, r2);
        trick[0].Set(QT_PARD, QT_BOTH, rank, 4);
        trick[1].Set(QT_ACE, QT_ACE, SDS_KING, 2);
        trick[2].Set(QT_BOTH, QT_PARD, SDS_JACK, 1);
      ...
      else if (htop.T == QT_PARD)
      {
        if (completeList[QT_PARD][2] > completeList[QT_ACE][2])
        {
          if (htop.N == QT_PARD || htop.E == QT_PARD)
          {
            ...
            // AKxx / 9xxx / JT8 / Qx.
            // AKxx / xxxx / JT8 / Q9.
            // PROBLEM (actual error) with rank.
            // Should be HR(QT_PARD, 2).
            if (pickFlag) holdCtr[0x1445]++;
            rank = HR(QT_PARD, 1); // PROBLEM
            trick[0].Set(QT_BOTH, QT_BOTH, SDS_JACK, 3);
        ...
        else if (htop.N == QT_LHO && htop.E == QT_ACE)
        {
          ...
          trick[1].Set(QT_BOTH, QT_PARD, SDS_VOID, 1);
          trick[2].Set(QT_ACE, QT_ACE, SDS_VOID, 1);
          trick[3].Set(QT_ACE, QT_BOTH, SDS_JACK, 3);
          return def.Set31(trick);
        }
      }
    }
      ...
      length[QT_RHO] == 3 && htop.T == QT_PARD)
  {
    if (htop.N == QT_PARD || (htop.N == QT_LHO && htop.E == QT_PARD))
    {
      if (completeList[QT_PARD][3] > completeList[QT_ACE][3])
      {
        ...
        trick[1].Set(QT_ACE, QT_ACE, SDS_VOID-3, 3);
...
bool LoopHold::SolveComplex62(DefList& def, unsigned& rank) const
{
      ...
      (htop.T == QT_PARD && htop.N == QT_ACE))
  {
        ...
        completeList[QT_PARD][2] > completeList[QT_ACE][2])
    {
      ...
      // The way it comes out.  Not necessarily correct.
      if (htop.T == QT_ACE)
      {
